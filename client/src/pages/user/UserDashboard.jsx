...
import ContactModal from "../../components/user/contacts/ContactModal.jsx";
import { verifyLoader } from "../../loader/verify-loader.js";
...
const UserDashboard = () => {
  ...
  useEffect(() => {
    if (!permissions) {
      ...
      permissions &&
      !permissions.split(",").includes("EDIT_CONTACT") &&
      !permissions.split(",").includes("DELETE_CONTACT")
    ) {
        ...
        >
          ...
          {allowActions && (
            <Column
              ...
              body={(rowData) => (
                <div>
                  {permissions && permissions.includes("EDIT_CONTACT") && (
                    <Button
                      icon="pi pi-pencil"
                  ...
                  {permissions && permissions.includes("DELETE_CONTACT") && (
                    <Button
                      icon="pi pi-trash"
    ...
    <div>
      <div className="my-6">
        <div className="flex justify-between items-center mb-5">
          ...
          {permissions && permissions.includes("CREATE_CONTACT") && (
            <Button
